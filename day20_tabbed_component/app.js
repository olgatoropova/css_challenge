...
const showEpisodePreview = (index, hrefElement) => {
    const episode = episodes[index];

    const allLiElements = episodesList.childNodes;
    allLiElements.forEach((el) => {
        el.classList.remove('selected');
    });

    const liElement = hrefElement.parentElement;
    ...
    mainElement.innerHTML =
        ...
        <div class="content">
            ...
            <a href="${episode.link}" class="more">More</a>
        </div>`;
}

episodesList.innerHTML = episodes.map((episode, i) => {
    return `<li>
            <a href="#" onclick="showEpisodePreview(${i}, this);">
