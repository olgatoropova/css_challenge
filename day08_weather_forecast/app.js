...
const getWeatherTypeByCode = (weatherCode) => {
    ...
    switch (Math.round(weatherCode / 100)) {
        ...
        case 6:
            return 'snowy';
        case 8:
            return (weatherCode == 800) ? 'sunny' :
                (weatherCode == 801) ? 'partly-cloudy' : 'cloudy';
        default:
...
const getWeatherForecast = async () => {
    try {
        ...
        const options = {
            method: 'GET',
            headers: {
                'X-RapidAPI-Key': '41f6510af3msheec2d84bf994d8ap14c088jsn1422780fb810',
                'X-RapidAPI-Host': 'weatherbit-v1-mashape.p.rapidapi.com'
            }
        };
        
        const res = await fetch('https://weatherbit-v1-mashape.p.rapidapi.com/forecast/daily?lat=74.1111&lon=-57.0592', options)
